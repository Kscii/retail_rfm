...
const profiles = [
  { code:'S1', name:'Long-inactive', customers:'1,054 · 24.30%', net:'5.71%', r:'246d', f:'1', m:'£300', strategy:'Possible strategy: low-cost reactivation', color:'var(--s1)' },
  { code:'S2', name:'Regular', customers:'2,827 · 65.17%', net:'35.58%', r:'37d', f:'3', m:'£716', strategy:'Possible strategy: repeat-purchase offers', color:'var(--s2)' },
  { code:'S3', name:'Active high-value', customers:'406 · 9.36%', net:'27.68%', r:'11d', f:'12', m:'£4,804', strategy:'Possible strategy: loyalty and retention', color:'var(--s3)' },
  { code:'S4', name:'Top-frequency high-value', customers:'51 · 1.18%', net:'31.03%', r:'4d', f:'34', m:'£30,301', strategy:'Possible strategy: high-touch service', color:'var(--s4)' },
]
</script>
    ...
    <div class="findings-body">
      <section class="profiles">
        <article v-for="profile in profiles" :key="profile.code" :style="{'--segment':profile.color}">
          ...
          <p class="strategy">{{ profile.strategy }}</p>
        </article>
      </section>
...
.strategy { margin-top: 7px !important; padding-top: 5px; border-top: 1px solid var(--line); color: var(--segment); font-size: 8px; font-weight: 800; line-height: 1.2; }
